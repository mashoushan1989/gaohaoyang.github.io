...
(function() {
   ...
   */
  var demoContent = [{
      demo_link: 'https://pp.io/?ash',
      img_link: 'https://pic4.zhimg.com/v2-68d7e5b0b111b7406297055905d91c35_xl.jpg',
      code_link: 'https://github.com/ppio/?ash',
      title: 'PPIO官网',
      core_tech: 'P2P',
      description: '基于区块链技术的去中心化存储与分发平台 <a href ="https://pp.io/?ash/">点击这里</a>。'
    },
    {
      demo_link: 'https://blog.pp.io/?ash',
      img_link: 'https://pic4.zhimg.com/v2-68d7e5b0b111b7406297055905d91c35_xl.jpg',
      code_link: 'https://github.com/ppio/?ash',
      title: 'PPIO官方博客',
      core_tech: 'P2P',
      description: '发布PPIO最新动态信息 <a href ="https://blog.pp.io/?ash">点击这里</a>。'
    },
    {
      demo_link: 'https://github.com/PPIO/Whitepaper/?ash',
      img_link: 'https://pic4.zhimg.com/v2-68d7e5b0b111b7406297055905d91c35_xl.jpg',
      code_link: 'https://github.com/ppio/?ash',
      title: 'PPIO英文白皮书',
      core_tech: 'P2P',
      description: '关于PPIO技术的具体论证及实现，英文 <a href ="https://github.com/PPIO/Whitepaper/?ash/">点击这里</a>。'
    },
    {
      demo_link: 'https://www.linkedin.com/company/pplabs/?ash',
      img_link: 'https://ss0.bdstatic.com/-0U0bnSm1A5BphGlnYG/tam-ogel/ae60db54936bb024336e75c7c90a8578_121_121.jpg',
      code_link: 'https://www.linkedin.com/company/pplabs/?ash',
      title: 'PPLabs领英主页',
      core_tech: 'P2P PPLabs blockchain',
      description: 'PPLabs在领英的主页 <a href ="https://www.linkedin.com/company/pplabs/?ash/">点击这里</a>。'
    },
    {
      demo_link: 'https://www.zhihu.com/org/ppio-62/activities/?ash',
      img_link: '',
      code_link: 'https://www.zhihu.com/org/ppio-62/activities/?ash',
      title: 'PPIO在知乎',
      core_tech: 'P2P 区块链',
      description: 'PPIO在知乎社区的问答，中文介绍PPIO的产品信息 <a href ="https://www.zhihu.com/org/ppio-62/activities/?ash/">点击这里</a>。'
    },
    {
      demo_link: 'http://www.enfi.cloud/?ash',
      img_link: 'http://www.enfi.cloud/img/logo-gray.71e67309.png',
      code_link: 'http://www.enfi.cloud/?ash',
      title: 'ENFI产品官网',
      core_tech: 'P2P golang',
      description: '内部孵化的新项目 <a href ="http://www.enfi.cloud/?ash/">点击这里</a>。'
    },
    // {
...
//   var htmlStr = ''
//   for (var i = 0; i < content.length; i++) {
//     htmlStr += '<div class="grid-item">' + '<a class="a-img" href="' + content[i].demo_link + '">' + ' <img src="' + content[i].img_link + '">' + '   </a>' + '   <h3 class="demo-title">' + '       <a href="' + content[i].demo_link + '">' + content[i].title + '</a>' + '   </h3>' + '   <p>主要技术：' + content[i].core_tech + '</p>' + '   <p>' + content[i].description +
//     '<a href="' + content[i].code_link + '">源代码 <i class="fa fa-code" aria-hidden="true"></i></a>' + '</p>' + '</div>'
//   }
